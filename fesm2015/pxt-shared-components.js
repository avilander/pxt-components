...
class PxtSubmenusComponent {
    ...
    constructor(_pxtAppService, _serviceBase) {
        ...
        setTimeout(() => {
            this.urlService = environment.esbApiPxt + this.model.constructor.name;
